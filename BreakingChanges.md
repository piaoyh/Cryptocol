...
| fn Hash::calculate_hash_code<const N: usize\>(&mut self, message: &[u8; N], counter: u32) -> [u8; N]                                                                                                  | calculate_hash_code(&mut self, message: &[u8], counter: u32) -> Vec<u8\>                                                                                                                                                           |
| fn PKCS1V15::set_prng(&mut self, prng: impl RNG)                                                                                                                                                      | fn PKCS1V15::set_prng(&mut self, prng: Box<dyn PRNG\>)                                                                                                                                                                             |
| fn OAEP::set_prng(&mut self, prng: impl RNG)                                                                                                                                                          | fn OAEP::set_prng(&mut self, prng: Box<dyn PRNG\>)                                                                                                                                                                                 |
| fn OAEP::set_hash(&mut self, hash: impl Hash)                                                                                                                                                         | fn OAEP::set_hash(&mut self, hash:  Box<dyn Hash\>)                                                                                                                                                                                |
