...
/// 
/// So, it will define `U256`, `U384`, `U512`, `U768`, `U1024`, `U2048`,
/// `U3072`, `U4096`, `U5120`, `U6144`, `U7168`, `U8192`, and  `U16384`
/// __based on `u128`__. That is, `U256` and `U1024` will be defined to be
...
macro_rules! define_utypes_with_u128
{
    () =>
    {
        use cryptocol::number::{ U256_with_u128, U384_with_u128, U512_with_u128, U768_with_u128,
                                U1024_with_u128, U2048_with_u128, U3072_with_u128, U4096_with_u128,
                                U5120_with_u128, U6144_with_u128, U7168_with_u128, U8192_with_u128,
                                U16384_with_u128 };

        /// 256-bit unsigned integer for 128-bit machines, Synonym of `U256_with_u128`
        pub type U256 = U256_with_u128;

        /// 384-bit unsigned integer for 128-bit machines, Synonym of `U384_with_u128`
        pub type U384 = U384_with_u128;

        /// 512-bit unsigned integer for 128-bit machines, Synonym of `U512_with_u128`
        pub type U512 = U512_with_u128;

        /// 768-bit unsigned integer for 128-bit machines, Synonym of `U768_with_u128`
        pub type U768 = U768_with_u128;
        ...
        /// 48-byte unsigned integer, Synonym of `U384`
        pub type UU48 = U384;

        /// 64-byte unsigned integer, Synonym of `U512`
        pub type UU64 = U512;

        /// 96-byte unsigned integer, Synonym of `U768`
        pub type UU96 = U768;
...
/// So, it will define `U256`, `U384`, `U512`, `U768`, `U1024`, `U2048`,
/// `U3072`, `U4096`, `U5120`, `U6144`, `U7168`, `U8192`, and `U16384`
/// __based on `u64`__. That is, `U256` and `U1024` will be defined to be
/// `BigUInt<u64, 4>` and `BigUInt<u64, 16>`, respectively, for example.
/// 
/// Furthermore, `UU32`, `UU48`, `UU64`, `UU96`, `UU128`, `UU256`, `UU384`,
/// `UU512`, `UU640`, `UU768`, `UU896`, `UU1024`, and `UU2048` will be also
/// defined to be `U256`, `U384`, `U512`, `U768`, `U1024`, `U2048`, `U3072`,
...
macro_rules! define_utypes_with_u64
{
    () =>
    {
        use cryptocol::number::{ U256_with_u64, U384_with_u64, U512_with_u64, U768_with_u64,
                                U1024_with_u64, U2048_with_u64, U3072_with_u64, U4096_with_u64,
                                U5120_with_u64, U6144_with_u64, U7168_with_u64, U8192_with_u64,
                                U16384_with_u64 };

        /// 256-bit unsigned integer for 64-bit machines, Synonym of `U256_with_u64`
        pub type U256 = U256_with_u64;

        /// 384-bit unsigned integer for 64-bit machines, Synonym of `U384_with_u64`
        pub type U384 = U384_with_u64;

        /// 512-bit unsigned integer for 64-bit machines, Synonym of `U512_with_u64`
        pub type U512 = U512_with_u64;

        /// 768-bit unsigned integer for 64-bit machines, Synonym of `U768_with_u64`
        pub type U768 = U768_with_u64;
...
macro_rules! define_utypes_with_u32
{
    () =>
    {
        use cryptocol::number::{ U256_with_u32, U384_with_u32, U512_with_u32, U768_with_u32,
                                U1024_with_u32, U2048_with_u32, U3072_with_u32, U4096_with_u32,
                                U5120_with_u32, U6144_with_u32, U7168_with_u32, U8192_with_u32,
                                U16384_with_u32 };

        /// 256-bit unsigned integer for 32-bit machines, Synonym of `U256_with_u32`
        pub type U256 = U256_with_u32;
        
        /// 384-bit unsigned integer for 32-bit machines, Synonym of `U384_with_u32`
        pub type U384 = U384_with_u32;

        /// 512-bit unsigned integer for 32-bit machines, Synonym of `U512_with_u32`
        pub type U512 = U512_with_u32;

        /// 768-bit unsigned integer for 32-bit machines, Synonym of `U768_with_u32`
        pub type U768 = U768_with_u32;
...
macro_rules! define_utypes_with_u16
{
    () =>
    {
        use cryptocol::number::{ U256_with_u16, U384_with_u16, U512_with_u16, U768_with_u16,
                                U1024_with_u16, U2048_with_u16, U3072_with_u16, U4096_with_u16,
                                U5120_with_u16, U6144_with_u16, U7168_with_u16, U8192_with_u16,
                                U16384_with_u16 };
                                
        /// 256-bit unsigned integer for 16-bit machines, Synonym of `U256_with_u16`
        pub type U256 = U256_with_u16;

        /// 384-bit unsigned integer for 16-bit machines, Synonym of `U384_with_u16`
        pub type U384 = U384_with_u16;

        /// 512-bit unsigned integer for 16-bit machines, Synonym of `U512_with_u16`
        pub type U512 = U512_with_u16;

        /// 768-bit unsigned integer for 16-bit machines, Synonym of `U768_with_u16`
        pub type U768 = U768_with_u16;
...
macro_rules! define_utypes_with_u8
{
    () =>
    {
        use cryptocol::number::{ U256_with_u8, U384_with_u8, U512_with_u8, U768_with_u8,
                                U1024_with_u8, U2048_with_u8, U3072_with_u8, U4096_with_u8,
                                U5120_with_u8, U6144_with_u8, U7168_with_u8, U8192_with_u8,
                                U16384_with_u8 };

        /// 256-bit unsigned integer for 8-bit machines, Synonym of `U256_with_u8`
        pub type U256 = U256_with_u8;

        /// 384-bit unsigned integer for 8-bit machines, Synonym of `U384_with_u8`
        pub type U384 = U384_with_u8;

        /// 512-bit unsigned integer for 8-bit machines, Synonym of `U512_with_u8`
        pub type U512 = U512_with_u8;

        /// 768-bit unsigned integer for 8-bit machines, Synonym of `U768_with_u8`
        pub type U768 = U768_with_u8;
