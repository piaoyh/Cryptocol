...
PRNG_Engine for Rijndael_Generic<ROUND, NB, NK, IRREDUCIBLE, AFFINE_MUL, AFFINE_ADD, SR0, SR1, SR2, SR3,
        ...
        RC0, RC1, RC2, RC3, RC4, RC5, RC6, RC7, RC8, RC9, ROT>
{
    ...
    fn harvest(&mut self, count: u64, message: &[u64; 8]) -> [u64; 8]
    {
        ...
        unsafe { copy_nonoverlapping(&count as *const u64 as *const u32, nonce.as_mut_ptr() as *mut u32, len); }
