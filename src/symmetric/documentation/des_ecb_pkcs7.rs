...
/// examples were moved to des_ecb_pkcs7.rs. And, most of generic parameters
...
/// traits_ecb_with_padding_pkcs7.rs was too big because of documentation
...
impl DES_Generic
{
    ...
    /// ```
    /// 
    /// # Example 8 forNormal case for the message of 16 bytes
    /// ```
    /// use std::io::Write;
    /// use std::fmt::Write as _;
    /// use cryptocol::symmetric::{ DES, ECB_PKCS7 };
