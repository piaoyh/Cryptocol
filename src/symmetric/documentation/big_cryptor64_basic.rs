...
impl <S: SmallCryptor<u64, 8>> BigCryptor64<S>
{
    ...
    /// Constructs a new object DES_Generic for the component of BigCryptor64.
    /// 
    /// # Arguments
    /// - The argument `key` is the array of u8 that has 8 elements.
    /// - Remember that inverted parity bits do not affect the 56-bit real key.
    ...
    /// 
    /// # Features
    /// - You won't use this method unless you use BigCryptor64 for such as Triple DES.
    /// - This method sets the key to be the given argument `key`.
    /// - This method constructs the encryptor component of BigCryptor64.
    /// 
    /// # Example 1
    /// ```
    /// use cryptocol::symmetric::{ DES, BigCryptor64 };
    /// 
    ...
    /// let mut tdes = BigCryptor64::new_with_small_des_array(keys);
    ...
    /// - You won't use this method unless you use BigCryptor64 for such as Triple DES.
    /// - This method sets the key to be the given argument `key`.
    /// - This method constructs the decryptor component of BigCryptor64.
    /// 
    /// # Example 1
    /// ```
    /// use cryptocol::symmetric::{ BigCryptor64, DES };
    ...
    /// - If it is constructed as encryptor for BigCryptor64,
    ///   it will be changed into decryptor.
    /// - If it is constructed as decryptor for BigCryptor64,
    ...
    /// Encrypts a 64-bit data when BigCryptor64 encrypting if the object was
    /// constructed as encryptor for BigCryptor64 such as Triple DES, and decrypts a
    /// 64-bit data when BigCryptor64 encrypting if the object was constructed as
    /// decryptor for BigCryptor64 such as Triple DES.
    /// 
    /// # Arguments
    /// `message` is of `u64`-type and the plaintext to be encrypted.
    /// 
    ...
    /// Decrypts a 64-bit data when BigCryptor64 decrypting if the object was
    /// constructed as encryptor for BigCryptor64 such as Triple DES, and encrypts a
    /// 64-bit data when BigCryptor64 decrypting if the object was constructed as
    /// decryptor for BigCryptor64 such as Triple DES.
    /// 
    /// # Arguments
