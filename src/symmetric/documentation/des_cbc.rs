...
impl <const ROUND: usize> DES_Generic<ROUND>
{
    ...
    pub fn decrypt_with_padding_pkcs7_cbc(&mut self, iv: u64, cipher: *const u8, length_in_bytes: u64, message: *mut u8) -> u64
    {
        unimplemented!(); // Dummy code for documentation
    }
    ...
    pub fn decrypt_with_padding_iso_cbc(&mut self, iv: u64, cipher: *const u8, length_in_bytes: u64, message: *mut u8) -> u64
    {
        unimplemented!(); // Dummy code for documentation
    }
