...
use crate::symmetric::{ SmallCryptor, SmallCryptor128,  Rijndael_Generic };
...
SmallCryptor<u128, 16> for Rijndael_Generic<ROUND, 4, NK,
                                                IRREDUCIBLE, AFFINE_MUL, AFFINE_ADD, SR0, SR1, SR2, SR3,
...
impl <const ROUND: usize, const NK: usize,
        ...
        const RC0: u32, const RC1: u32, const RC2: u32, const RC3: u32, const RC4: u32,
        const RC5: u32, const RC6: u32, const RC7: u32, const RC8: u32, const RC9: u32, const ROT: u32>
SmallCryptor128 for Rijndael_Generic<ROUND, 4, NK,
                                    IRREDUCIBLE, AFFINE_MUL, AFFINE_ADD, SR0, SR1, SR2, SR3,
                                    MC00, MC01, MC02, MC03, MC10, MC11, MC12, MC13,
                                    MC20, MC21, MC22, MC23, MC30, MC31, MC32, MC33,
                                    RC0, RC1, RC2, RC3, RC4, RC5, RC6, RC7, RC8, RC9, ROT>
