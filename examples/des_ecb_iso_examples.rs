...
pub fn main()
{
    ...
    des_encrypt_with_padding_iso_ecb_into_vec();
    des_encrypt_with_padding_iso_ecb_into_array();
    des_encrypt_str_with_padding_iso_ecb();
    des_encrypt_str_with_padding_iso_ecb_into_vec();
    des_encrypt_str_with_padding_iso_ecb_into_array();
    des_encrypt_string_with_padding_iso_ecb();
    des_encrypt_string_with_padding_iso_ecb_into_vec();
    des_encrypt_string_with_padding_iso_ecb_into_array();
    des_encrypt_vec_with_padding_iso_ecb();
    des_encrypt_vec_with_padding_iso_ecb_into_vec();
    des_encrypt_vec_with_padding_iso_ecb_into_array();
    des_encrypt_array_with_padding_iso_ecb();
    des_encrypt_array_with_padding_iso_ecb_into_vec();
    des_encrypt_array_with_padding_iso_ecb_into_array();

    des_decrypt_with_padding_iso_ecb();
    des_decrypt_with_padding_iso_ecb_into_vec();
    des_decrypt_with_padding_iso_ecb_into_array();
    des_decrypt_with_padding_iso_ecb_into_string();
    des_decrypt_vec_with_padding_iso_ecb();
    des_decrypt_vec_with_padding_iso_ecb_into_vec();
    des_decrypt_vec_with_padding_iso_ecb_into_array();
    des_decrypt_vec_with_padding_iso_ecb_into_string();
    des_decrypt_array_with_padding_iso_ecb();
    des_decrypt_array_with_padding_iso_ecb_into_vec();
    des_decrypt_array_with_padding_iso_ecb_into_array();
    des_decrypt_array_with_padding_iso_ecb_into_string();
}
