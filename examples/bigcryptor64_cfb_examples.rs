...
pub fn main()
{
    bigcryptor64_encrypt_cfb();
    bigcryptor64_encrypt_cfb_into_vec();
    bigcryptor64_encrypt_cfb_into_array();
    bigcryptor64_encrypt_str_cfb();
    bigcryptor64_encrypt_str_cfb_into_vec();
    bigcryptor64_encrypt_str_cfb_into_array();
    bigcryptor64_encrypt_string_cfb();
    bigcryptor64_encrypt_string_cfb_into_vec();
    bigcryptor64_encrypt_string_cfb_into_array();
    bigcryptor64_encrypt_vec_cfb();
    bigcryptor64_encrypt_vec_cfb_into_vec();
    bigcryptor64_encrypt_vec_cfb_into_array();
    bigcryptor64_encrypt_array_cfb();
    bigcryptor64_encrypt_array_cfb_into_vec();
    bigcryptor64_encrypt_array_cfb_into_array();

    bigcryptor64_decrypt_cfb();
    bigcryptor64_decrypt_cfb_into_vec();
    bigcryptor64_decrypt_cfb_into_array();
    bigcryptor64_decrypt_cfb_into_string();
    bigcryptor64_decrypt_vec_cfb();
    bigcryptor64_decrypt_vec_cfb_into_vec();
    bigcryptor64_decrypt_vec_cfb_into_array();
    bigcryptor64_decrypt_vec_cfb_into_string();
    bigcryptor64_decrypt_array_cfb();
    bigcryptor64_decrypt_array_cfb_into_vec();
    bigcryptor64_decrypt_array_cfb_into_array();
    bigcryptor64_decrypt_array_cfb_into_string();
}
