...
fn aes_encrypt_with_padding_pkcs7_ecb()
{
    ...
    use cryptocol::symmetric::{ AES_128, AES_192, AES_256, ECB_PKCS7 };
...
fn aes_encrypt_with_padding_pkcs7_ecb_into_vec()
{
    ...
    c_aes.encrypt_into_vec(message.as_ptr(), message.len() as u64, &mut cipher1);
    d_aes.encrypt_into_vec(message.as_ptr(), message.len() as u64, &mut cipher2);
    print!("C (0 rounds) =\t");
...
fn aes_encrypt_with_padding_pkcs7_ecb_into_array()
{
    ...
    c_aes.encrypt_into_array(message.as_ptr(), message.len() as u64, &mut cipher1);
    d_aes.encrypt_into_array(message.as_ptr(), message.len() as u64, &mut cipher2);
    print!("C (0 rounds) =\t");
    for c in cipher1.clone()
        { print!("{:02X} ", c); }
    println!();
...
fn aes_encrypt_str_with_padding_pkcs7_ecb()
{
    ...
    let mut cipher1 = [0_u8; 56];
    let mut cipher2 = [0_u8; 56];
    c_aes.encrypt_str(&message, cipher1.as_mut_ptr());
    d_aes.encrypt_str(&message, cipher2.as_mut_ptr());
    print!("C (0 rounds) =\t");
    for c in cipher1.clone()
        { print!("{:02X} ", c); }
    println!();
...
fn aes_encrypt_str_with_padding_pkcs7_ecb_into_vec()
{
    ...
    let mut cipher1 = Vec::<u8>::new();
    let mut cipher2 = Vec::<u8>::new();
    c_aes.encrypt_str_into_vec(&message, &mut cipher1);
    d_aes.encrypt_str_into_vec(&message, &mut cipher2);
    print!("C (0 rounds) =\t");
    for c in cipher1.clone()
        { print!("{:02X} ", c); }
    println!();
...
fn aes_encrypt_str_with_padding_pkcs7_ecb_into_array()
{
    ...
    let mut cipher1 = [0_u8; 56];
    let mut cipher2 = [0_u8; 56];
    c_aes.encrypt_str_into_array(&message, &mut cipher1);
    d_aes.encrypt_str_into_array(&message, &mut cipher2);
    print!("C (0 rounds) =\t");
    for c in cipher1.clone()
        { print!("{:02X} ", c); }
    println!();
...
fn aes_encrypt_string_with_padding_pkcs7_ecb()
{
    ...
    let mut cipher1 = [0_u8; 56];
    let mut cipher2 = [0_u8; 56];
    c_aes.encrypt_string(&message, cipher1.as_mut_ptr());
    d_aes.encrypt_string(&message, cipher2.as_mut_ptr());
    print!("C (0 rounds) =\t");
    for c in cipher1.clone()
        { print!("{:02X} ", c); }
    println!();
...
fn aes_encrypt_string_with_padding_pkcs7_ecb_into_vec()
{
    ...
    let mut cipher1 = Vec::<u8>::new();
    let mut cipher2 = Vec::<u8>::new();
    c_aes.encrypt_string_into_vec(&message, &mut cipher1);
    d_aes.encrypt_string_into_vec(&message, &mut cipher2);
    print!("C (0 rounds) =\t");
    for c in cipher1.clone()
        { print!("{:02X} ", c); }
    println!();
...
fn aes_encrypt_string_with_padding_pkcs7_ecb_into_array()
{
    ...
    let mut cipher1 = [0_u8; 56];
    let mut cipher2 = [0_u8; 56];
    c_aes.encrypt_string_into_array(&message, &mut cipher1);
    d_aes.encrypt_string_into_array(&message, &mut cipher2);
    print!("C (0 rounds) =\t");
    for c in cipher1.clone()
        { print!("{:02X} ", c); }
    println!();
...
fn aes_encrypt_vec_with_padding_pkcs7_ecb()
{
    ...
    let mut cipher1 = [0_u8; 56];
    let mut cipher2 = [0_u8; 56];
    c_aes.encrypt_vec(&message, cipher1.as_mut_ptr());
    d_aes.encrypt_vec(&message, cipher2.as_mut_ptr());
    print!("C (0 rounds) =\t");
    for c in cipher1.clone()
        { print!("{:02X} ", c); }
    println!();
...
fn aes_encrypt_vec_with_padding_pkcs7_ecb_into_vec()
{
    ...
    let mut cipher1 = Vec::<u8>::new();
    let mut cipher2 = Vec::<u8>::new();
    c_aes.encrypt_vec_into_vec(&message, &mut cipher1);
    d_aes.encrypt_vec_into_vec(&message, &mut cipher2);
    print!("C (0 rounds) =\t");
    for c in cipher1.clone()
        { print!("{:02X} ", c); }
    println!();
...
fn aes_encrypt_vec_with_padding_pkcs7_ecb_into_array()
{
    ...
    let mut cipher1 = [0_u8; 56];
    let mut cipher2 = [0_u8; 56];
    c_aes.encrypt_vec_into_array(&message, &mut cipher1);
    d_aes.encrypt_vec_into_array(&message, &mut cipher2);
    print!("C (0 rounds) =\t");
    for c in cipher1.clone()
        { print!("{:02X} ", c); }
    println!();
...
fn aes_encrypt_array_with_padding_pkcs7_ecb()
{
    ...
    let mut cipher = [0_u8; 56];
    a_aes.encrypt_array(&message, cipher.as_mut_ptr());
    print!("C (16 rounds) =\t");
    for c in cipher.clone()
        { print!("{:02X} ", c); }
    println!();
    ...
    let mut cipher1 = [0_u8; 56];
    let mut cipher2 = [0_u8; 56];
    c_aes.encrypt_array(&message, cipher1.as_mut_ptr());
    d_aes.encrypt_array(&message, cipher2.as_mut_ptr());
    print!("C (0 rounds) =\t");
    for c in cipher1.clone()
        { print!("{:02X} ", c); }
    println!();
...
fn aes_encrypt_array_with_padding_pkcs7_ecb_into_vec()
{
    ...
    let mut cipher1 = Vec::<u8>::new();
    let mut cipher2 = Vec::<u8>::new();
    c_aes.encrypt_array_into_vec(&message, &mut cipher1);
    d_aes.encrypt_array_into_vec(&message, &mut cipher2);
    print!("C (0 rounds) =\t");
    for c in cipher1.clone()
        { print!("{:02X} ", c); }
    println!();
...
fn aes_encrypt_array_with_padding_pkcs7_ecb_into_array()
{
    ...
    let mut cipher1 = [0_u8; 56];
    let mut cipher2 = [0_u8; 56];
    c_aes.encrypt_array_into_array(&message, &mut cipher1);
    d_aes.encrypt_array_into_array(&message, &mut cipher2);
    print!("C (0 rounds) =\t");
    for c in cipher1.clone()
        { print!("{:02X} ", c); }
    println!();
...
fn aes_decrypt_with_padding_pkcs7_ecb()
{
    ...
    c_aes.decrypt(cipher1.as_ptr(), cipher1.len() as u64, recovered1.as_mut_ptr());
    d_aes.decrypt(cipher2.as_ptr(), cipher2.len() as u64, recovered2.as_mut_ptr());
    print!("B1a (0 rounds) =\t");
    ...
    let len = a_aes.decrypt(cipher.as_ptr(), cipher.len() as u64, recovered.as_mut_ptr());
    print!("Ba =\t");
    for b in recovered.clone()
        { print!("{:02X} ", b); }
    println!();
...
fn aes_decrypt_with_padding_pkcs7_ecb_into_vec()
{
    ...
    c_aes.decrypt_into_vec(cipher1.as_ptr(), cipher1.len() as u64, &mut recovered1);
    d_aes.decrypt_into_vec(cipher2.as_ptr(), cipher2.len() as u64, &mut recovered2);
    print!("B1a (0 rounds) =\t");
    for b in recovered1.clone()
        { print!("{:02X} ", b); }
    println!();
...
fn aes_decrypt_with_padding_pkcs7_ecb_into_array()
{
    ...
    let len1 = c_aes.decrypt_into_array(cipher1.as_ptr(), cipher1.len() as u64, &mut recovered1);
    let len2 = d_aes.decrypt_into_array(cipher2.as_ptr(), cipher2.len() as u64, &mut recovered2);
    print!("B1a (0 rounds) =\t");
    for b in recovered1.clone()
        { print!("{:02X} ", b); }
    println!();
...
fn aes_decrypt_with_padding_pkcs7_ecb_into_string()
{
    ...
    a_aes.decrypt_into_string(cipher.as_ptr(), cipher.len() as u64, &mut recovered);
    ...
    c_aes.decrypt_into_string(cipher1.as_ptr(), cipher1.len() as u64, &mut recovered1);
    d_aes.decrypt_into_string(cipher2.as_ptr(), cipher2.len() as u64, &mut recovered2);
...
fn aes_decrypt_vec_with_padding_pkcs7_ecb()
{
    ...
    let mut recovered1 = vec![0; 55];
    let mut recovered2 = vec![0; 55];
    c_aes.decrypt_vec(&cipher1, recovered1.as_mut_ptr());
    d_aes.decrypt_vec(&cipher2, recovered2.as_mut_ptr());
    print!("B1a (0 rounds) =\t");
    for b in recovered1.clone()
        { print!("{:02X} ", b); }
    println!();
    ...
    let mut recovered = vec![0; 8];
    let len = a_aes.decrypt_vec(&cipher, recovered.as_mut_ptr());
    print!("Ba =\t");
    for b in recovered.clone()
        { print!("{:02X} ", b); }
    println!();
...
fn aes_decrypt_vec_with_padding_pkcs7_ecb_into_vec()
{
    ...
    let mut recovered1 = Vec::<u8>::new();
    let mut recovered2 = Vec::<u8>::new();
    c_aes.decrypt_vec_into_vec(&cipher1, &mut recovered1);
    d_aes.decrypt_vec_into_vec(&cipher2, &mut recovered2);
    print!("B1a (0 rounds) =\t");
    for b in recovered1.clone()
        { print!("{:02X} ", b); }
    println!();
...
fn aes_decrypt_vec_with_padding_pkcs7_ecb_into_array()
{
    ...
    let mut recovered1 = [0u8; 56];
    let mut recovered2 = [0u8; 56];
    let len1 = c_aes.decrypt_vec_into_array(&cipher1, &mut recovered1);
    let len2 = d_aes.decrypt_vec_into_array(&cipher2, &mut recovered2);
    print!("B1a (0 rounds) =\t");
    for b in recovered1.clone()
        { print!("{:02X} ", b); }
    println!();
...
fn aes_decrypt_vec_with_padding_pkcs7_ecb_into_string()
{
    ...
    let mut recovered = String::new();
    a_aes.decrypt_vec_into_string(&cipher, &mut recovered);
    println!("B (16 rounds) =\t{}", recovered);
    assert_eq!(recovered, "In the beginning God created the heavens and the earth.");
    assert_eq!(recovered, message);
    println!();
    ...
    let mut recovered1 = String::new();
    let mut recovered2 = String::new();
    c_aes.decrypt_vec_into_string(&cipher1, &mut recovered1);
    d_aes.decrypt_vec_into_string(&cipher2, &mut recovered2);
    println!("B1 (0 rounds) =\t{}", recovered1);
    println!("B2 (0 rounds) =\t{}", recovered2);
    assert_eq!(recovered1, "In the beginning God created the heavens and the earth.");
    assert_eq!(recovered2, "In the beginning God created the heavens and the earth.");
...
fn aes_decrypt_array_with_padding_pkcs7_ecb()
{
    ...
    let mut recovered = vec![0; 55];
    let len = a_aes.decrypt_array(&cipher, recovered.as_mut_ptr());
    ...
    let mut recovered1 = vec![0; 55];
    let mut recovered2 = vec![0; 55];
    let len1 = c_aes.decrypt_array(&cipher1, recovered1.as_mut_ptr());
    let len2 = d_aes.decrypt_array(&cipher2, recovered2.as_mut_ptr());
...
fn aes_decrypt_array_with_padding_pkcs7_ecb_into_vec()
{
    ...
    let mut recovered1 = Vec::<u8>::new();
    let mut recovered2 = Vec::<u8>::new();
    c_aes.decrypt_array_into_vec(&cipher1, &mut recovered1);
    d_aes.decrypt_array_into_vec(&cipher2, &mut recovered2);
    print!("B1a (0 rounds) =\t");
    for b in recovered1.clone()
        { print!("{:02X} ", b); }
    println!();
...
fn aes_decrypt_array_with_padding_pkcs7_ecb_into_array()
{
    ...
    let mut recovered1 = [0u8; 56];
    let mut recovered2 = [0u8; 56];
    let len1 = c_aes.decrypt_array_into_array(&cipher1, &mut recovered1);
    let len2 = d_aes.decrypt_array_into_array(&cipher2, &mut recovered2);
    print!("B1a (0 rounds) =\t");
    for b in recovered1.clone()
        { print!("{:02X} ", b); }
    println!();
...
fn aes_decrypt_array_with_padding_pkcs7_ecb_into_string()
{
    ...
    let mut recovered = String::new();
    a_aes.decrypt_array_into_string(&cipher, &mut recovered);
    println!("B (16 rounds) =\t{}", recovered);
    assert_eq!(recovered, "In the beginning God created the heavens and the earth.");
    assert_eq!(recovered, message);
    println!();
    ...
    let mut recovered1 = String::new();
    let mut recovered2 = String::new();
    c_aes.decrypt_array_into_string(&cipher1, &mut recovered1);
    d_aes.decrypt_array_into_string(&cipher2, &mut recovered2);
    println!("B1 (0 rounds) =\t{}", recovered1);
    println!("B2 (0 rounds) =\t{}", recovered2);
    assert_eq!(recovered1, "In the beginning God created the heavens and the earth.");
    assert_eq!(recovered2, "In the beginning God created the heavens and the earth.");
