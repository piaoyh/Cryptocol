...
fn des_decrypt_vec_with_padding_pkcs7()
{
    ...
    let mut recovered1 = vec![0; 55];
    let mut recovered2 = vec![0; 55];
    c_des.decrypt_vec_with_padding_pkcs7(&cipher1, recovered1.as_mut_ptr());
    d_des.decrypt_vec_with_padding_pkcs7(&cipher2, recovered2.as_mut_ptr());
    print!("B1a (0 rounds) =\t");
    for b in recovered1.clone()
        { print!("{:02X} ", b); }
    println!();
    ...
    let mut recovered = vec![0; 8];
    let len = a_des.decrypt_vec_with_padding_pkcs7(&cipher, recovered.as_mut_ptr());
    print!("Ba =\t");
    for b in recovered.clone()
        { print!("{:02X} ", b); }
    println!();
...
fn des_decrypt_vec_with_padding_pkcs7_into_vec()
{
    ...
    let mut recovered = Vec::<u8>::new();
    a_des.decrypt_vec_with_padding_pkcs7_into_vec(&cipher, &mut recovered);
    print!("Ba (16 rounds) =\t");
    for b in recovered.clone()
        { print!("{:02X} ", b); }
    println!();
    ...
    let mut recovered1 = Vec::<u8>::new();
    let mut recovered2 = Vec::<u8>::new();
    c_des.decrypt_vec_with_padding_pkcs7_into_vec(&cipher1, &mut recovered1);
    d_des.decrypt_vec_with_padding_pkcs7_into_vec(&cipher2, &mut recovered2);
    print!("B1a (0 rounds) =\t");
    for b in recovered1.clone()
        { print!("{:02X} ", b); }
    println!();
...
fn des_decrypt_vec_with_padding_pkcs7_into_array()
{
    ...
    let mut recovered = [0u8; 56];
    let len = a_des.decrypt_vec_with_padding_pkcs7_into_array(&cipher, &mut recovered);
    print!("Ba (16 rounds) =\t");
    for b in recovered.clone()
        { print!("{:02X} ", b); }
    println!();
    ...
    let mut recovered1 = [0u8; 56];
    let mut recovered2 = [0u8; 56];
    let len1 = c_des.decrypt_vec_with_padding_pkcs7_into_array(&cipher1, &mut recovered1);
    let len2 = d_des.decrypt_vec_with_padding_pkcs7_into_array(&cipher2, &mut recovered2);
    print!("B1a (0 rounds) =\t");
    for b in recovered1.clone()
        { print!("{:02X} ", b); }
    println!();
...
fn des_decrypt_vec_with_padding_pkcs7_into_string()
{
    ...
    let mut recovered = String::new();
    a_des.decrypt_vec_with_padding_pkcs7_into_string(&cipher, &mut recovered);
    println!("B (16 rounds) =\t{}", recovered);
    assert_eq!(recovered, "In the beginning God created the heavens and the earth.");
    assert_eq!(recovered, message);
    println!();
    ...
    let mut recovered1 = String::new();
    let mut recovered2 = String::new();
    c_des.decrypt_vec_with_padding_pkcs7_into_string(&cipher1, &mut recovered1);
    d_des.decrypt_vec_with_padding_pkcs7_into_string(&cipher2, &mut recovered2);
    println!("B1 (0 rounds) =\t{}", recovered1);
    println!("B2 (0 rounds) =\t{}", recovered2);
    assert_eq!(recovered1, "In the beginning God created the heavens and the earth.");
    assert_eq!(recovered2, "In the beginning God created the heavens and the earth.");
...
fn des_decrypt_array_with_padding_pkcs7_into_vec()
{
    ...
    let mut recovered = Vec::<u8>::new();
    a_des.decrypt_array_with_padding_pkcs7_into_vec(&cipher, &mut recovered);
    print!("Ba (16 rounds) =\t");
    for b in recovered.clone()
        { print!("{:02X} ", b); }
    println!();
    ...
    let mut recovered1 = Vec::<u8>::new();
    let mut recovered2 = Vec::<u8>::new();
    c_des.decrypt_array_with_padding_pkcs7_into_vec(&cipher1, &mut recovered1);
    d_des.decrypt_array_with_padding_pkcs7_into_vec(&cipher2, &mut recovered2);
    print!("B1a (0 rounds) =\t");
    for b in recovered1.clone()
        { print!("{:02X} ", b); }
    println!();
...
fn des_decrypt_array_with_padding_pkcs7_into_array()
{
    ...
    let mut recovered1 = [0u8; 56];
    let mut recovered2 = [0u8; 56];
    let len1 = c_des.decrypt_array_with_padding_pkcs7_into_array(&cipher1, &mut recovered1);
    let len2 = d_des.decrypt_array_with_padding_pkcs7_into_array(&cipher2, &mut recovered2);
    print!("B1a (0 rounds) =\t");
    for b in recovered1.clone()
        { print!("{:02X} ", b); }
    println!();
...
fn des_decrypt_array_with_padding_pkcs7_into_string()
{
    ...
    let mut recovered1 = String::new();
    let mut recovered2 = String::new();
    c_des.decrypt_array_with_padding_pkcs7_into_string(&cipher1, &mut recovered1);
    d_des.decrypt_array_with_padding_pkcs7_into_string(&cipher2, &mut recovered2);
    println!("B1 (0 rounds) =\t{}", recovered1);
    println!("B2 (0 rounds) =\t{}", recovered2);
    assert_eq!(recovered1, "In the beginning God created the heavens and the earth.");
    assert_eq!(recovered2, "In the beginning God created the heavens and the earth.");
...
fn des_decrypt_with_padding_iso()
{
    ...
    let mut recovered = vec![0; 55];
    a_des.decrypt_with_padding_iso(cipher.as_ptr(), cipher.len() as u64, recovered.as_mut_ptr());
    print!("Ba (16 rounds) =\t");
    for b in recovered.clone()
        { print!("{:02X} ", b); }
    println!();
    ...
    let mut recovered1 = vec![0; 55];
    let mut recovered2 = vec![0; 55];
    c_des.decrypt_with_padding_iso(cipher1.as_ptr(), cipher1.len() as u64, recovered1.as_mut_ptr());
    d_des.decrypt_with_padding_iso(cipher2.as_ptr(), cipher2.len() as u64, recovered2.as_mut_ptr());
    print!("B1a (0 rounds) =\t");
    for b in recovered1.clone()
        { print!("{:02X} ", b); }
    println!();
    ...
    let mut recovered = vec![0; 8];
    let len = a_des.decrypt_with_padding_iso(cipher.as_ptr(), cipher.len() as u64, recovered.as_mut_ptr());
    print!("Ba =\t");
    for b in recovered.clone()
        { print!("{:02X} ", b); }
    println!();
...
fn des_decrypt_with_padding_iso_into_array()
{
    ...
    let mut recovered = [0u8; 56];
    let len = a_des.decrypt_with_padding_iso_into_array(cipher.as_ptr(), cipher.len() as u64, &mut recovered);
    print!("Ba (16 rounds) =\t");
    for b in recovered.clone()
        { print!("{:02X} ", b); }
    println!();
    ...
    let mut recovered1 = [0u8; 56];
    let mut recovered2 = [0u8; 56];
    let len1 = c_des.decrypt_with_padding_iso_into_array(cipher1.as_ptr(), cipher1.len() as u64, &mut recovered1);
    let len2 = d_des.decrypt_with_padding_iso_into_array(cipher2.as_ptr(), cipher2.len() as u64, &mut recovered2);
    print!("B1a (0 rounds) =\t");
    for b in recovered1.clone()
        { print!("{:02X} ", b); }
    println!();
...
fn des_decrypt_with_padding_iso_into_string()
{
    ...
    let mut recovered1 = String::new();
    let mut recovered2 = String::new();
    c_des.decrypt_with_padding_iso_into_string(cipher1.as_ptr(), cipher1.len() as u64, &mut recovered1);
    d_des.decrypt_with_padding_iso_into_string(cipher2.as_ptr(), cipher2.len() as u64, &mut recovered2);
    println!("B1 (0 rounds) =\t{}", recovered1);
    println!("B2 (0 rounds) =\t{}", recovered2);
    assert_eq!(recovered1, "In the beginning God created the heavens and the earth.");
    assert_eq!(recovered2, "In the beginning God created the heavens and the earth.");
...
fn des_decrypt_vec_with_padding_iso()
{
    ...
    let mut recovered1 = vec![0; 55];
    let mut recovered2 = vec![0; 55];
    c_des.decrypt_vec_with_padding_iso(&cipher1, recovered1.as_mut_ptr());
    d_des.decrypt_vec_with_padding_iso(&cipher2, recovered2.as_mut_ptr());
    print!("B1a (0 rounds) =\t");
    for b in recovered1.clone()
        { print!("{:02X} ", b); }
    println!();
...
{
    println!("des_decrypt_vec_with_padding_iso_into_vec");
    use std::fmt::Write;
    use cryptocol::symmetric::{ DES, DES_Expanded };
    ...
    let mut recovered = Vec::<u8>::new();
    a_des.decrypt_vec_with_padding_iso_into_vec(&cipher, &mut recovered);
    print!("Ba (16 rounds) =\t");
    for b in recovered.clone()
        { print!("{:02X} ", b); }
    println!();
    ...
    let mut recovered1 = Vec::<u8>::new();
    let mut recovered2 = Vec::<u8>::new();
    c_des.decrypt_vec_with_padding_iso_into_vec(&cipher1, &mut recovered1);
    d_des.decrypt_vec_with_padding_iso_into_vec(&cipher2, &mut recovered2);
    print!("B1a (0 rounds) =\t");
    for b in recovered1.clone()
        { print!("{:02X} ", b); }
    println!();
...
fn des_decrypt_vec_with_padding_iso_into_array()
{
    ...
    let mut recovered = [0u8; 56];
    let len = a_des.decrypt_vec_with_padding_iso_into_array(&cipher, &mut recovered);
    print!("Ba (16 rounds) =\t");
    for b in recovered.clone()
        { print!("{:02X} ", b); }
    println!();
    ...
    let mut recovered1 = [0u8; 56];
    let mut recovered2 = [0u8; 56];
    let len1 = c_des.decrypt_vec_with_padding_iso_into_array(&cipher1, &mut recovered1);
    let len2 = d_des.decrypt_vec_with_padding_iso_into_array(&cipher2, &mut recovered2);
    print!("B1a (0 rounds) =\t");
    for b in recovered1.clone()
        { print!("{:02X} ", b); }
    println!();
...
fn des_decrypt_vec_with_padding_iso_into_string()
{
    ...
    let mut recovered = String::new();
    a_des.decrypt_vec_with_padding_iso_into_string(&cipher, &mut recovered);
    println!("B (16 rounds) =\t{}", recovered);
    assert_eq!(recovered, "In the beginning God created the heavens and the earth.");
    assert_eq!(recovered, message);
    println!();
    ...
    let mut recovered1 = String::new();
    let mut recovered2 = String::new();
    c_des.decrypt_vec_with_padding_iso_into_string(&cipher1, &mut recovered1);
    d_des.decrypt_vec_with_padding_iso_into_string(&cipher2, &mut recovered2);
    println!("B1 (0 rounds) =\t{}", recovered1);
    println!("B2 (0 rounds) =\t{}", recovered2);
    assert_eq!(recovered1, "In the beginning God created the heavens and the earth.");
    assert_eq!(recovered2, "In the beginning God created the heavens and the earth.");
